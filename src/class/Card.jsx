      ...
      <div 
        ...
        <div className="contact">
          <div className='contact-email'
              ...
              <svg 
                width={`${this.state.email_size+2}px`}
                height={`${this.state.email_size+2}px`}
                viewBox="0 0 24 24"
                fill={ this.state.email_color }
          ...
          <div className='contact-phone'
            ...
            <svg 
              width={`${this.state.phone_size+1}px`}
              height={`${this.state.phone_size+1}px`}
              viewBox="0 0 24 24" 
              fill={ this.state.phone_color }
              xmlns="http://www.w3.org/2000/svg"
            >
